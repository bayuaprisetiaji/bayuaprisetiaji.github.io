...
function wakil_kepala($id){
    global $koneksi;
    $sql1  = "select * from wakilkepala where id = '$id'";
    $q1 = mysqli_query($koneksi,$sql1);
    $r1 = mysqli_fetch_array($q1);
    $foto = $r1['foto'];
...
function buat_link_waka($id){
    ...
    // http://localhost/website-company-profile/halaman.php/8/judul
    return url_dasar()."/wakilkepala.php/$id/$nama";
}

function tenaga_pendidik($id){
    global $koneksi;
...
function buat_link_guru($id){
    ...
    $nama  = bersihkan_judul($r1['nama']);
    // http://localhost/website-company-profile/halaman.php/8/judul
    return url_dasar()."/guru.php/$id/$nama";
}

function tata_usaha($id){
    global $koneksi;
    $sql1  = "select * from tatausaha where id = '$id'";
    $q1 = mysqli_query($koneksi,$sql1);
    $r1 = mysqli_fetch_array($q1);
    $foto = $r1['foto'];
...
function buat_link_tatausaha($id){
    global $koneksi;
    $sql1    = "select * from tatausaha where id = '$id'";
    $q1     = mysqli_query($koneksi,$sql1);
    $r1     = mysqli_fetch_array($q1);
    $nama  = bersihkan_judul($r1['nama']);
    // http://localhost/website-company-profile/halaman.php/8/judul
    return url_dasar()."/tatausaha.php/$id/$nama";
}

function Partnership($id){
    global $koneksi;
    $sql1  = "select * from partnership where id = '$id'";
    $q1 = mysqli_query($koneksi,$sql1);
    $r1 = mysqli_fetch_array($q1);
    $foto = $r1['foto'];
...
function buat_link_partnership($id){
    global $koneksi;
    $sql1    = "select * from partnership where id = '$id'";
    $q1     = mysqli_query($koneksi,$sql1);
    $r1     = mysqli_fetch_array($q1);
    $nama  = bersihkan_judul($r1['nama']);
    // http://localhost/website-company-profile/halaman.php/8/judul
    return url_dasar()."/partnership.php/$id/$nama";
}
...
function buat_link_galeri($id){
    global $koneksi;
    $sql1    = "select * from galeri where id = '$id'";
    $q1     = mysqli_query($koneksi,$sql1);
    $r1     = mysqli_fetch_array($q1);
    $foto  = bersihkan_judul($r1['foto']);
    // http://localhost/website-company-profile/halaman.php/8/judul
