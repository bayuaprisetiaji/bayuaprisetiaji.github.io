...
if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
        if($foto_name){
            $direktori = "../uploads/galeri/";
            @unlink($direktori."/$foto"); //delete data
            $foto_name = "galeri_".time()."_".$foto_name;
        ...
        if($id != ""){
            $sql1   = "update galeri set nama = '$nama',foto='$foto_name',isi='$isi',tgl_isi=now() where id = '$id'";
        }else{
            $sql1       = "insert into galeri(nama,foto,isi) values ('$nama','$foto','$isi')";
        }
...
?>
<h1>Halaman Tambah Data Galeri</h1>
<div class="mb-3 row">
    <a href="galeri.php">
        << Kembali ke halaman Data galeri</a>
</div>
<?php
if ($error) {
?>
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <?php 
            if($foto){
                echo "<img src='../uploads/galeri/$foto' style='max-height:100px;max-width:100px'/>";
            }
            ?>
