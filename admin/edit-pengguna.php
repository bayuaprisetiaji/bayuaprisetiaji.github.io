						...
						<form action="" method="POST">
							...
							<div class="form-group">
								...
								<select name="level" class="input-control" required>
									...
									<option value="SuperAdmin" <?= ($p->level == 'SuperAdmin')? 'selected':''; ?>>Super Admin</option>
									<option value="Admin" <?= ($p->level == 'Admin')? 'selected':''; ?>>Admin</option>
								</select>
							</div>
							<div class="form-group">
								<label>Password</label>
								<input type="text" name="pass" placeholder="Password" class="input-control"  value="<?= $p->password ?>" required>
							</div>
