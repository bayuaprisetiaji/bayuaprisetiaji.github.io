...
if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
        if($foto_name){
            ...
            $foto_name = "wakilkepala_".time()."_".$foto_name;
        ...
        if($id != ""){
            $sql1   = "update wakilkepala set nama = '$nama',jabatan = '$jabatan',foto='$foto_name',isi='$isi',tgl_isi=now() where id = '$id'";
        }else{
            $sql1       = "insert into wakilkepala(nama,jabatan,foto,isi) values ('$nama','$jabatan','$foto','$isi')";
        }
...
?>
<h1>Halaman Tambah Data Wakil Kepala</h1>
<div class="mb-3 row">
    <a href="wakilkepala.php">
        << Kembali ke halaman Data Wakil Kepala</a>
</div>
<?php
if ($error) {
?>
