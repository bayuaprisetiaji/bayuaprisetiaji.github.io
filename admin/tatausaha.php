...
if ($op == 'delete') {
    $id = $_GET['id'];
    $sql1   = "select foto from tatausaha where id = '$id'";
    $q1     = mysqli_query($koneksi, $sql1);
    $r1     = mysqli_fetch_array($q1);
    @unlink("../gambar/".$r1['foto']);

    $sql1   = "delete from tatausaha where id = '$id'";
    $q1     = mysqli_query($koneksi, $sql1);
    if ($q1) {
...
?>
<h1>Halaman Admin Tata Usaha</h1>
<p>
    <a href="tatausaha_input.php">
        <input type="button" class="btn btn-primary" value="Tambah Data Tata Usaha" />
    </a>
</p>
<?php
if ($sukses) {
...
<form class="row g-3" method="get">
    <div class="col-auto">
        <input type="text" class="form-control" placeholder="Masukkan Nama Tata Usaha" name="katakunci" value="<?php echo $katakunci ?>" />
    </div>
    <div class="col-auto">
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        $sql1   = "select * from tatausaha $sqltambahan";
        ...
        ?>
            <tr>
                ...
                <td><img src="../gambar/<?php echo tata_usaha ($r1['id'])?>" style="max: height 100px;max: width 100px;"/></td>
                <td><?php echo $r1['nama'] ?></td>
                
                <td>
                    <a href="tatausaha_input.php?id=<?php echo $r1['id']?>">
                        <span class="badge bg-warning text-dark">Edit</span>
                    </a>

                    <a href="tatausaha.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Apakah yakin mau hapus data bro?')">
...
<nav aria-label="Page navigation example">
    <ul class="pagination">
        ...
        for($i=1; $i <= $pages; $i++){
            ?>
            <li class="page-item">
                <a class="page-link" href="tatausaha.php?katakunci=<?php echo $katakunci?>&cari=<?php echo $cari?>&page=<?php echo $i ?>"><?php echo $i ?></a>
            </li>
            <?php
        }
        ?>
