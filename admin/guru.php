...
if ($op == 'delete') {
    $id = $_GET['id'];
    $sql1   = "select foto from guru where id = '$id'";
...
<p>
    <a href="guru_input.php">
        <input type="button" class="btn btn-primary" value="Tambah Data Guru" />
    </a>
</p>
<?php
if ($sukses) {
...
<form class="row g-3" method="get">
    <div class="col-auto">
        <input type="text" class="form-control" placeholder="Masukkan Nama Guru" name="katakunci" value="<?php echo $katakunci ?>" />
    </div>
    <div class="col-auto">
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        $sql1   = "select * from guru $sqltambahan";
        ...
        ?>
            <tr>
                ...
                <td><img src="../gambar/<?php echo tenaga_pendidik ($r1['id'])?>" style="max: height 100px;max: width 100px;"/></td>
                <td><?php echo $r1['nama'] ?></td>
                
                <td>
                    <a href="guru_input.php?id=<?php echo $r1['id']?>">
                        <span class="badge bg-warning text-dark">Edit</span>
                    </a>

                    <a href="guru.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Apakah yakin mau hapus data bro?')">
...
<nav aria-label="Page navigation example">
    <ul class="pagination">
        ...
        for($i=1; $i <= $pages; $i++){
            ?>
            <li class="page-item">
                <a class="page-link" href="guru.php?katakunci=<?php echo $katakunci?>&cari=<?php echo $cari?>&page=<?php echo $i ?>"><?php echo $i ?></a>
            </li>
            <?php
        }
        ?>
