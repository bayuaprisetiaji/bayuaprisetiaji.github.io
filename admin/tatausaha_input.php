...
if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
        if($foto_name){
            ...
            $foto_name = "tatausaha_".time()."_".$foto_name;
        ...
        if($id != ""){
            $sql1   = "update tatausaha set nama = '$nama',jabatan = '$jabatan',foto='$foto_name',isi='$isi',tgl_isi=now() where id = '$id'";
        }else{
            $sql1       = "insert into tatausaha(nama,jabatan,foto,isi) values ('$nama','$jabatan','$foto','$isi')";
        }
...
?>
<h1>Halaman Tambah Data Tata Usaha</h1>
<div class="mb-3 row">
    <a href="tatausaha.php">
        << Kembali ke halaman Data Tata Usaha</a>
</div>
<?php
if ($error) {
?>
