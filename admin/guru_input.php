...
if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
        if($foto_name){
            ...
            $foto_name = "guru_".time()."_".$foto_name;
        ...
        if($id != ""){
            $sql1   = "update guru set nama = '$nama',foto='$foto_name',isi='$isi',tgl_isi=now() where id = '$id'";
        }else{
            $sql1       = "insert into guru(nama,foto,isi) values ('$nama','$foto','$isi')";
        }
...
<div class="mb-3 row">
    <a href="guru.php">
        << Kembali ke halaman Data Guru</a>
</div>
<?php
if ($error) {
?>
