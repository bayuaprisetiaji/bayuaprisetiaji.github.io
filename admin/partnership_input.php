...
if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
        if($foto_name){
            ...
            $foto_name = "partnership_".time()."_".$foto_name;
        ...
        if($id != ""){
            $sql1   = "update partnership set nama = '$nama',foto='$foto_name',isi='$isi',tgl_isi=now() where id = '$id'";
        }else{
            $sql1       = "insert into partnership(nama,foto,isi) values ('$nama','$foto','$isi')";
        }
...
?>
<h1>Halaman Tambah Data partnership</h1>
<div class="mb-3 row">
    <a href="partnership.php">
        << Kembali ke halaman Data partnership</a>
</div>
<?php
if ($error) {
?>
